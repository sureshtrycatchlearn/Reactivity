...
namespace Infrastructure.Security
{
    ...
    public class IsHostReqirementHandler : AuthorizationHandler<IsHostReqirement>
    {
        private readonly DataContext _dbcontext;

        private readonly IHttpContextAccessor _httpContextAccessor;

        public IsHostReqirementHandler(DataContext dbcontext, IHttpContextAccessor httpContextAccessor )
        {
